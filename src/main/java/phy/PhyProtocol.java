...
public class PhyProtocol extends Protocol {
	 ...
	 */
	@Override
	public Msg receive() throws IOException, SocketTimeoutException {
	 ...
	 */
	public Msg receive(int timeout) throws IOException, SocketTimeoutException {
